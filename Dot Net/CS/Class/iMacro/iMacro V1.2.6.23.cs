...
//        Text = Text.Replace(" ", "<SP>");
    ...
    {
        int j;
        Encoding outputEnc = new UTF8Encoding(); // create encoding with BOM
        if (FileName.Substring(FileName.Length - 4) == ".iim")
        {
            if (File.Exists(iMacro_SaveAddress + "\\" + FileName) == true)
            {
                System.IO.StreamWriter file =
                    new System.IO.StreamWriter(iMacro_SaveAddress + "\\" + FileName,false, Encoding.UTF8);
        ...
        else
        {
            ...
            {
                System.IO.StreamWriter file =
                       new System.IO.StreamWriter(iMacro_SaveAddress + "\\" + FileName + ".iim", false, Encoding.UTF8);
    ...
    public void iMacro_CreatFile(string FileName)
    {
        ...
        if (FileName.Substring(FileName.Length - 4) == ".iim")
        {
            ...
            {
                System.IO.StreamWriter file = new System.IO.StreamWriter(iMacro_SaveAddress + "\\" + FileName, false, Encoding.UTF8);
                file.Close();
            }
        }
        else
        {
            ...
            {
                System.IO.StreamWriter file = new System.IO.StreamWriter(iMacro_SaveAddress + "\\" + FileName + ".iim", false, Encoding.UTF8);
                file.Close();
            }
        }
    }
